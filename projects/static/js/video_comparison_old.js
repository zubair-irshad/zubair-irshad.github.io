...
function playVids(videoId) {
    ...
    if (vid.readyState > 3) {
        ...
        // videoMerge.addEventListener("mousemove", throttle(trackLocation, 100), false);
        // videoMerge.addEventListener("touchmove", throttle(trackLocationTouch, 100), false);
        // window.addEventListener("resize", debounce(() => resizeAndPlay(element), 200));

        var lastDrawTime = 0;

        function drawLoop() {

            // if (timestamp - lastDrawTime < 16) { // Limit to around 60 fps
